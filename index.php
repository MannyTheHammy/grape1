...
<html class="loading">
  ...
  <div class="content-body">
    ...
    <option </option>
				...
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd5CCN.php">𝘾𝘾𝙉 𝘾𝙃𝘼𝙍𝙂𝙀: $5</option>
				
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd1CVV.php">𝘾𝙑𝙑 𝘾𝙃𝘼𝙍𝙂𝙀: $1</option>

				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd5CVV.php">𝘾𝙑𝙑 𝘾𝙃𝘼𝙍𝙂𝙀: $5</option>
...
var callBack = $.ajax({
	url: gate + '?lista=' + data + '&sec=' + sec + '&bec=' +  bec,
