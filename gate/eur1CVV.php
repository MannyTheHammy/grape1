...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount='.$chr.'&currency=eur&payment_method_types[]=card&description=GRAPEJUICE Donation&payment_method='.$tok1.'&confirm=true&off_session=true');  
